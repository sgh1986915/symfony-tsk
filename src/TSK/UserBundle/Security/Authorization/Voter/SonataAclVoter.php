...
class SonataAclVoter extends AclVoter
{
    ...
    */
    ...
    {
        return is_subclass_of($class, 'Sonata\AdminBundle\Admin\AdminInterface');
    }

    public function supportsAttribute($attribute)
    {
        $this->permissionMap->contains($attribute);
    }

    /**
     * vote 
     * This is borrowed from JMS\SecurityExtraBundle\Security\Acl\Voter\AclVoter
     * 
